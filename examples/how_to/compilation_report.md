...
Generated: 2025-12-19 20:01:28 UTC
...
*   Issue report:
  [understanding_cmls_non-blocking_architecture_034.md](../issues/understanding_cmls_non-blocking_architecture_034.md)

### `linda_tuple_space_system_from_book_chapter_9_039.cr`
*   Error: `Showing last frame. Use --error-trace for full trace.`
*   Issue report:
  [linda_tuple_space_system_from_book_chapter_9_039.md](../issues/linda_tuple_space_system_from_book_chapter_9_039.md)
...
*   Issue report:
  [linda_tuple_space_system_from_book_chapter_9_043.md](../issues/linda_tuple_space_system_from_book_chapter_9_043.md)

### `common_pitfalls_and_solutions_031.cr`
*   Error: `Showing last frame. Use --error-trace for full trace.`
*   Issue report:
  [common_pitfalls_and_solutions_031.md](../issues/common_pitfalls_and_solutions_031.md)

### `linda_tuple_space_system_from_book_chapter_9_042.cr`
*   Error: `Showing last frame. Use --error-trace for full trace.`
*   Issue report:
  [linda_tuple_space_system_from_book_chapter_9_042.md](../issues/linda_tuple_space_system_from_book_chapter_9_042.md)

### `linda_tuple_space_system_from_book_chapter_9_040.cr`
*   Error: `Showing last frame. Use --error-trace for full trace.`
*   Issue report:
  [linda_tuple_space_system_from_book_chapter_9_040.md](../issues/linda_tuple_space_system_from_book_chapter_9_040.md)

### `understanding_cmls_non-blocking_architecture_036.cr`
*   Error: `Showing last frame. Use --error-trace for full trace.`
*   Issue report:
  [understanding_cmls_non-blocking_architecture_036.md](../issues/understanding_cmls_non-blocking_architecture_036.md)

### `understanding_cmls_non-blocking_architecture_037.cr`
*   Error: `Showing last frame. Use --error-trace for full trace.`
*   Issue report:
  [understanding_cmls_non-blocking_architecture_037.md](../issues/understanding_cmls_non-blocking_architecture_037.md)

### `synchronization_primitives_016.cr`
*   Error: `Showing last frame. Use --error-trace for full trace.`
*   Issue report:
  [synchronization_primitives_016.md](../issues/synchronization_primitives_016.md)
